...
- Testing Specification: PyEDI_Core_Testing_Specification-user-supplied.md (attached/in project root)

YOUR OBJECTIVES:
1. Verify the directory structure matches the specification
...
- for the data comparison the input will be 200220261215033.dat
- for the data comparison the output will be 200220261215033.json
